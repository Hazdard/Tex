...
% Faire la liste de ce qui change dans la stratégie quand on passe à des équations plus dure pour lesquelles on ne connait pas de profile exacte.
...
% Expliquer que dans le cas de CCF, c'est dur de trouver une solution de l'eq auto similaire, et aussi de trouver des lambdas, que pour le faire on utilise de l'IA, mettre l'image de Tristan sur les PINNs 
 % Dire que les calculs rigoureux servent par exemple à montrer l'inégalité d'énergie.
\begin{frame}
\tableofcontents
\end{frame}  
