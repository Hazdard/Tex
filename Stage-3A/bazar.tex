...
% Comprendre comment dériver Euler (via wiki) et faire les calculs pour aller en polaire
...
% expliquer pourquoi le damping damp : lutte contre la dérivéeé temporelle, et lemme A.1 donne une estimée précise.
% Deux trucs dans le papier : géométrie de la singularité stable (au sens C^4 pour la géométrie asymptotique auto similaire du choc) ; et purement azymuthale (en se ramenant à la sol 1D)
