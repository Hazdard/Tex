...
&\leq&  C\frac{4A^2}{n}  \sup_{y\in[-A,A]}{\Big(\left|\partial_yK(x,y)\right| + \left|2\pi K(x,y)\right| \Big)} \| f\|_{H^3} \\
\end{eqnarray*}

Where $C := \max\Big(\displaystyle \int_\R \frac{1}{(1+\xi^2)^2} \mathrm{d}\xi,\int_\R \frac{\xi^2}{(1+\xi^2)^3} \mathrm{d}\xi\Big)$ and we used the fact that, because $f\in H^3(\R)$, we have: \[\| \hat{f}(\xi)\|_{L^1} = \| \frac{1}{(1+\xi^2)}(1+\xi^2)\hat{f}(\xi)\|_{L^1} \leq \| \frac{1}{(1+\xi^2)}\|_{L^2} \|(1+\xi^2)\hat{f}(\xi)\|_{L^2} = \| \frac{1}{(1+\xi^2)}\|_{L^2} \| f\|_{H^2}  \] 
and  \[\| \xi\hat{f}(\xi)\|_{L^1} = \| \frac{\xi}{(1+\xi^2)^{3/2}}(1+\xi^2)^{3/2}\hat{f}(\xi)\|_{L^1} \leq \| \frac{\xi}{(1+\xi^2)^{3/2}}\|_{L^2} \|(1+\xi^2)^{3/2}\hat{f}(\xi)\|_{L^2} = \| \frac{\xi}{(1+\xi^2)^{3/2}}\|_{L^2} \| f\|_{H^3}  \] 
