...
% Sources : Topo + Analyse : L3 --> Ulm --> Début Rudin --> M1 nul --> Villani IAF --> livre Alazard --> cours PGerard 
...
% D'ailleurs faire la liste des méthodes pour obtenir une convergence.
% D'ailleurs x2 : s'inspirer fortement du recap à la fin du cours de topo de Chafaï
...
% Parler de jauge, liens avec distance, et voir oraux cassinis x-ens.
