...
%-Probabilités : LeGall
%-Topo reprendre le cours d'Ulm et leurs exams en plus. Début Rudin.
%-Fourier (faire mon poly) ? utiliser JB et JBB et Alazard et Rudin et PbsD'Evol et Antoine Levitt et Villani
%-Analyse : Mirebeau et fact check avec Alazard et P. Gérard et Villani
% Villani pour tous les trucs ci-dessus



% Topo ; ana_r ; ana_fonc ; geom ; hilbert ?



%Théorie de la mesure : Rajouter que la mesure image par une matrice inversible de la mesure de Lebesgue revient juste à multiplier par le jacobien. Théorème de Haar à rajouter dans TMI ? Mettre une première partie de définitions et propriétés élémentaires ?
