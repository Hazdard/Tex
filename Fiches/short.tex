...
%Outils généraux : encadrement integral, equivalent log, transfo d’abel, regle de bioche, methode de la phase stationnaire (Laplace) ; Zorn ; Vitali ; Cantor-Bernstein, Césaro
...
% Analyse (Hilbertienne) et EDPs : Cauchy-Lipschitz, Gronwall, Lax-Milgram, Fourier, Cours d'EDP, Céa, densité C infini à support compact dans Lp. dans autres trucs mettre norme découlant d'un p.s. ssi parallélogramme.
