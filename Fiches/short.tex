...
%Outils généraux : encadrement integral, equivalent log, transfo d’abel, regle de bioche, methode de la phase stationnaire (Laplace) ; Zorn ; Vitali ; Cantor-Bernstein
