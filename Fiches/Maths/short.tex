...
%Faire un chapitre analyse et y mettre formules de Taylor, TAF, TVI, théorèmes de limite de prépa (double limite, cv uniforme de la suite des dérivées, etc ...), Inversion locale, fonctions implicites, rang constant et la remarque qui va avec, bij continue sur un compact est un homéo (Poincaré), série de Neumann (= ouverture de GL(E)), C^k homéo est un C^k difféo, théorèmes d'analyse fonctionnelle (peut-être dans une autre section).
...
% Analyse (Hilbertienne) et EDPs : Cauchy-Lipschitz, Gronwall, Lax-Milgram, Fourier, Cours d'EDP, Céa
