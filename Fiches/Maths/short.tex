...
% Dire que le seul but de l'analyse c'est de faire converger des suites (et de trouver des points fixes), en général on doit deviner la limite, si complet alors Cauchy miracle, etc ...

% Analyse (Hilbertienne) et EDPs : Lax-Milgram en corollaire, Fourier, Cours d'EDP, Céa
