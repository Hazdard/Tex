...
%En méthode d’apprentissage, se demander quelle est l’étape d’après quand on suit une conf, un livre, un cours, … Se demander quels sont les résultats qu’on veut, quels sont ceux qu’on peut avoir naturellement, et comment faire les preuves.
%Quand on lit un article, comprendre le paysage dans lequel le papier s’inscrit, et quelle est la nouveauté.
...
% LIRE WIKIPEDIA : Lagrangian mechanics ; Lagrange multiplier ; Implicit function theorem ; Théorème de Lebesgue-Vitali ; Cameron–Martin theorem
% Histoire : Louis Bachelier 

% Le lemme qui dit "unique vp dans un compact => convergence" est hyper pratique car comme la complétude (ou la monotonie), c'est une manière de prouver la convergence sans connaitre la limite.

% Go focus Fourier, analyse harmonique, pseudo/para-diff ? Plutôt opérateurs de diffusion markovien et entropie ?
...
% Dire que les matrices aléatoire ça vient des stats, en particulier avec Wishart (et oui après c'est Wigner)

%algèbre : dm de spé, début avec permutations, polynomes (et leurs racines), puis algèbre linéaire groupe de matrices. Réviser aussi un peu Sylow, et cours chelou Laszlo. Cartan-von Neumann : https://www.youtube.com/watch?v=FaCaM6v9Q2o
