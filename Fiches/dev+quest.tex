...
%Miscellanous :
% "Nirenberg and Joe Kohn created the theory of pseudo-differential operators, an extended version of the Calderon-Zygmund singular integral operators. c'est aux edp à coefficients variables ce que Fourier est aux edp avec des opérateurs aux coefficients constants.s
