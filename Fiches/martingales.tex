...
% Critère de De la Vallée - Poussin : https://djalil.chafai.net/blog/2014/03/09/de-la-vallee-poussin-on-uniform-integrability/


% Rajouter dans autre résultats de théorie de la mesure la tension des mesures finies sur un espace polonais.

% Intuition de l'espérance conditionnelle : c'est la meilleure approximation de la variable qu'on peut faire en ayant accès à l'information de la tribu sur laquelle on projète. 
