...
%Rajouter la cv en loi et ses props (cf chap 8)

% Schéma des implications de cv (version Trouvé et LeGall) + Scheffé 
...
\begin{rmq}
Avec des résultats sur les espérances conditionnelles, on peut aussi obtenir la convergence au sens $L^1$ dans le théorème ci-dessus.
\end{rmq}
