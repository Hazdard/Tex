...
% Schéma des implications de cv (version Trouvé et LeGall) + Scheffé + commentaire que cv L1 et p.s sont de natures différentes, et p.s est plus naturelle pour les probas.
