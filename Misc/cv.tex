...
\begin{document}
    ...
    \section{Education}
        ...
        \begin{onecolentry}
            \begin{highlights}
                \item \begin{twocolentry}{Sept 2024 - July 2025}\textbf{Master 1 :} Master Jacques Hadamard, Paris-Saclay University. \end{twocolentry}
                \item \begin{twocolentry}{Sept 2023 - July 2024}\textbf{License 3 :} License de Mathématiques renforcée, Paris-Saclay University. \end{twocolentry}
            \end{highlights}
        \end{onecolentry}
