...
\begin{twocolentry}{July 2024}
    \textbf{Undergraduate degree in Mathematics} (License renforcée), University Paris-Saclay, ENS Paris-Saclay.
\end{twocolentry}

\vspace{0.2cm}

\begin{twocolentry}{July 2023}
    \textbf{Undergraduate degree in Computer Science} (License renforcée), University Paris-Saclay, ENS Paris-Saclay.
\end{twocolentry}
