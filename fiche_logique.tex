...
\underline{Rq} : La preuve est ridicule, on utilise au moins deux fois l'axiome du choix (dont une fois passée sous silence ...), en gros il faut considérer d'abord le cas dénombrable et se représenter l'hypothèse sous la forme d'un arbre binaire. Généralisation avec zornette. \\
