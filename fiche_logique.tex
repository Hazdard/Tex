...
\begin{itemize}
\item[•] Pour chaque sorte $s$, un ensemble $\mathcal{D}_s$ non vide, appelé \textbf{domaine} d'interpréation (de la sorte $s$).
...
\textbf{Théorème :} Soient $\Lambda$ est un ensemble fini de formules,et $P$ une formule. Si $ \Lambda \vdash P$ est prouvable en déduction naturelle, alors $\Lambda \models P$.
