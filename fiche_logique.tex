...
\begin{tabular}{|C{3cm}|C{6cm}|C{7cm}|}
  ...
  \hline
  $\Rightarrow$ & {\Large $\frac{\Gamma \  \vdash \ A,\Delta	 \ \ \ B,\Gamma \ \vdash \ \Delta}{A \Rightarrow B,\Gamma \  \vdash \ \Delta}$} & {\Large $\frac{A,\Gamma \  \vdash \ \Delta,B}{\Gamma \  \vdash \ \Delta,A \Rightarrow B}$} \\
  \hline
\end{tabular}
\\
\\
