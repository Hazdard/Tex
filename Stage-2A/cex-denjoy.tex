...
Soit $w:[0, +\infty] \mapsto [0, +\infty]$ un module de continuité, en considérant la fonction $g$ construite dans la partie précédente, on a le lemme :

\begin{lemma}
$g'$ est continue pour le module $w$ $\Leftrightarrow \displaystyle \sup_{n\in \mathbb{Z}} \left |\frac{l_{n+1}}{l_n}-1 \right |\frac{1}{w(l_n)} <+ \infty$
\end{lemma}
