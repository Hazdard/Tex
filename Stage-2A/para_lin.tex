...
\end{equation*}
grâce au \fcref{young}, puis aux accroissements finis, et finalement avec une majoration d'un reste géométrique dans la caractérisation des espaces de Sobolev \eqref{carac_sobol}. Ainsi le second membre vérifie l'inégalité \eqref{eq2}. \\
...
\end{align*}
où l'on a utilisé \eqref{utillem}, ce qui donne finalement la majoration attendue pour le premier membre, et permet de conclure la preuve du \fcref{paralin}
\end{proof}
