...
\end{lemma}
\textbf{Preuve :} \\
Pour alléger les notations, on pose $A_i := \text{Rot}_f(a_i)$. Premièrement, si $a_i$ est non nul, alors $A_i$ est inversible (la preuve est \hyperref[sec:inv]{ici} en annexe).
