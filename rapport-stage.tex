...
Cette construction a été motivée par le problème suivant : si l'on utilise la version standard de LWE pour construire des protocoles, ces derniers auront une efficacité très réduite à cause d'opérations faisant intervenir de grandes matrices aléatoires. Une solution, proposée par Stehlé \textit{et al.} \cite{plwe},  dldnsqkjdnqs
\\
