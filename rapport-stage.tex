...
En revenant au problème LWE-Décisionnel, on constate que ce dernier se réduit à une instance de BDD dans le réseau engendré par les colonnes de $[A^\top,qI_m]$.
...
On majore ensuite le facteur pré-exponentiel :
