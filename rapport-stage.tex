...
\end{theorem}
\textbf{Preuve :} \\
On utilise la norme euclidienne, donc le carré de la norme d'une vecteur est égal à la somme des carrés de ses composantes. De plus le moment d'ordre deux d'une gaussienne centrée est égal à sa variance $\sigma^2$, ce qui donne les résultats voulus par linéarité de l'espérance.
